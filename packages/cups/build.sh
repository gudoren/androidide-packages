...
TERMUX_PKG_DEPENDS="libc++, libiconv, libcrypt, libgnutls, krb5"
...
termux_step_make() {
	make LIBS="-pthread $LDFLAGS -Wl,--hash-style=both -lm -lcrypt -liconv -lz -lgnutls -lgssapi_krb5" -j${TERMUX_MAKE_PROCESSES}
}
