...
TERMUX_PKG_DEPENDS="boost, enblend, exiftool, exiv2, fftw, glew, glu, libc++, libflann, libjpeg-turbo, libpano13, libpng, libsqlite, libtiff, libvigra, littlecms, mesa, wxwidgets, zlib"
